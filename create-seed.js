...
db.serialize(() => {
    ...
    const stmtDevice = db.prepare(`INSERT INTO device_registry (display_name, ip, port, key1, key2) VALUES (?, ?, ?, ?, ?)`);
    ...
    for (let i = 1; i <= 8; i++) {
        ...
        stmtDevice.run(`Controller ${i}`, `192.168.0.${200 - 1 + i}`, 502, 0x5555, 0xDDDD);
    ...
    const signalMappings = [
        ...
        { label: '110VAC (AO-CH-1)', type: 'analog-out', device_id: 1, reg_address: 40001, pos_x: 1100, pos_y: 190 },
        { label: '5A AC (AO-CH-2)', type: 'analog-out', device_id: 2, reg_address: 40001, pos_x: 1200, pos_y: 190 },
        { label: '4-20mA (AO-CH-3)', type: 'analog-out', device_id: 3, reg_address: 40001, pos_x: 1300, pos_y: 190 },
        { label: '0-10V (AO-CH-4)', type: 'analog-out', device_id: 4, reg_address: 40001, pos_x: 1400, pos_y: 190 },
        { label: '110VAC (AI-CH-1)', type: 'analog-in', device_id: 1, reg_address: 30005, scale_address: 40105, offset_address: 40107, deadzone_address: 40109, pos_x: 1100, pos_y: 400 },
        { label: '110VAC (AI-CH-2)', type: 'analog-in', device_id: 1, reg_address: 30009, scale_address: 40117, offset_address: 40119, deadzone_address: 40121, pos_x: 1200, pos_y: 400 },
        { label: '5A AC (AI-CH-3)', type: 'analog-in', device_id: 2, reg_address: 30005, scale_address: 40105, offset_address: 40107, deadzone_address: 40109, pos_x: 1300, pos_y: 400 },
        { label: '5A AC (AI-CH-4)', type: 'analog-in', device_id: 2, reg_address: 30009, scale_address: 40117, offset_address: 40119, deadzone_address: 40121, pos_x: 1400, pos_y: 400 },
        { label: '0-10V (AI-CH-5)', type: 'analog-in', device_id: 3, reg_address: 30005, scale_address: 40105, offset_address: 40107, deadzone_address: 40109, pos_x: 1100, pos_y: 610 },
        { label: '0-10V (AI-CH-6)', type: 'analog-in', device_id: 3, reg_address: 30009, scale_address: 40117, offset_address: 40119, deadzone_address: 40121, pos_x: 1200, pos_y: 610 },
        { label: '4-20mA (AI-CH-7)', type: 'analog-in', device_id: 4, reg_address: 30005, scale_address: 40105, offset_address: 40107, deadzone_address: 40109, pos_x: 1300, pos_y: 610 },
        { label: '4-20mA (AI-CH-8)', type: 'analog-in', device_id: 4, reg_address: 30009, scale_address: 40117, offset_address: 40119, deadzone_address: 40121, pos_x: 1400, pos_y: 610 },
    ];
    ...
    `, (err, rows) => {
        ...
        signalMappings.forEach(mapping => {
            ...
            if (mapping.cal_scale_reg_id) {
                const sr = rows.find(r => r.device_id === mapping.device_id && r.address === mapping.cal_scale_reg_id);
                if (sr) scaleRegId = sr.id;
            } else if (mapping.scale_address) {
                const sr = rows.find(r => r.device_id === mapping.device_id && r.address === mapping.scale_address);
                if (sr) scaleRegId = sr.id;
            }

            if (mapping.cal_offset_reg_id) {
                const or = rows.find(r => r.device_id === mapping.device_id && r.address === mapping.cal_offset_reg_id);
                if (or) offsetRegId = or.id;
            } else if (mapping.offset_address) {
                const or = rows.find(r => r.device_id === mapping.device_id && r.address === mapping.offset_address);
                if (or) offsetRegId = or.id;
            }

            if (mapping.cal_deadzone_reg_id) {
                const dr = rows.find(r => r.device_id === mapping.device_id && r.address === mapping.cal_deadzone_reg_id);
                if (dr) deadzoneRegId = dr.id;
            } else if (mapping.deadzone_address) {
